...
def test_upload_backfill_metadata_fills_missing_fields_and_tracks_usage() -> None:
...
def test_upload_backfill_metadata_retries_invalid_response_once_then_succeeds() -> None:
    from comicbook.nodes.upload_backfill_metadata import upload_backfill_metadata
...
def test_upload_backfill_metadata_marks_rows_failed_when_backfill_disabled() -> None:
    from comicbook.nodes.upload_backfill_metadata import upload_backfill_metadata
...
def test_upload_backfill_metadata_allows_missing_optional_when_backfill_disabled() -> None:
    from comicbook.nodes.upload_backfill_metadata import upload_backfill_metadata
...
def test_upload_backfill_metadata_marks_budget_exceeded_before_transport_call() -> None:
    from comicbook.nodes.upload_backfill_metadata import upload_backfill_metadata
...
def test_upload_backfill_metadata_trips_short_circuit_after_two_transport_failures() -> None:
    from comicbook.nodes.upload_backfill_metadata import upload_backfill_metadata

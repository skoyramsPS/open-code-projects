...
- [Implementation Execution Agent](implementation-execution-agent/index.md): what to expect from the agent that advances implementation guides in small, resumable slices and waits for explicit `/implement-next` approval before coding starts.

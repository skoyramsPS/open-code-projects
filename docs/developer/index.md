...
- [Implementation Execution Agent](implementation-execution-agent/index.md): invocation, skill reuse, and handoff contract for commit-sized implementation sessions with an explicit `/implement-next` approval boundary.

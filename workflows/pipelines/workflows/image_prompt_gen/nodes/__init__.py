"""Image prompt generation workflow nodes."""
...
_WORKFLOW = "image_prompt_gen"


def instrument_image_node(
    node: str,
    *,
    ...
    """Wrap an image-workflow node with standard lifecycle logging."""

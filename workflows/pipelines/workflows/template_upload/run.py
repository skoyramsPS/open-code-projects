...
from pipelines.shared.execution import format_timestamp, pid_is_alive
    ...
    *,
    ...
    try:
        ...
        log_event(
            ...
            dry_run=dry_run,
            stdin_mode=stdin_text is not None,
            message="Template upload run started",
        )
        ...
        log_event(
            ...
            message="Template upload run completed",
        )
        return final_state
        ...
        log_event(
            ...
            run_id=import_run_id,
            level="ERROR",
            message="Template upload run failed",
...
def main(argv: Sequence[str] | None = None) -> int:
    ...
    try:
        ...
        log_event(
            ...
            workflow=WORKFLOW,
            level="ERROR",
            message="Template upload CLI failed",
            error_message=str(exc),
        )
        print(str(exc), file=sys.stderr)
        return 5

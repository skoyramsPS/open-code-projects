...
- the layout migration is in progress; tests may still live under `ComicBook/tests/`. New tests should target the target structure and the implementation guide records when each subtree moves
